...
int main(){
    ...
    FILE *fp;
    int k = 0;
    if( (fp=fopen("fine-grainedH264-8-1-30-400-MACHINE8-NORESET-2object-3600.txt","rt"))!=NULL) {
        while( !feof(fp)) {
            fscanf(fp,"%s",str);
            flag = true;
            if(str[0] == '['){
    ...
    int k1 = 0;
    if( (fp=fopen("fine-grainedH264-8-1-30-400-NSGAII-MACHINE8-NORESET-2object-3600.txt","rt"))!=NULL) {
        while( !feof(fp)) {
            fscanf(fp,"%s",str);
            flag = true;
            if(str[0] == '['){
