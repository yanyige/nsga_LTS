...
int pop, gen;
int isdep[5][MAXN];//被i依赖的个数
int todep[5][MAXN];//i依赖的任务数
...
void evaluate_objective(Individual *i)
{
    ...
    i->makespan = 0;
    i->workload = 0;
    double depcopy[5][MAXN][MAXN];
    int isdepcopy[5][MAXN],todepcopy[5][MAXN];
